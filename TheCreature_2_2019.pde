...
float   ballX             = 100 ,  ballY             = 100;    //skiftede til float
float   eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5;      //skiftede til float
float   eyeRightRelativeX = 20  ,  eyeRightRelativeY = 5;      //skiftede til float
float   speedX            = 1   ,  speedY            = 1;      //skiftede til float
float ballSize          = 50;
float eyeSize           = 5;
float zoomFactor        = 1.01;
float ballwalk;                                                //declare ballwalk outside loop
...
void draw() {                         
  ...
  ballY         =  ballY  +  speedY + ballwalk;                //added ballwalk to y position
